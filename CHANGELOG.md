...
* Команда генерации отетов из XML теперь одна: она адаптируется под место из которого вызывается и добавляет теги Quetion и Page на своё усмотрение. Добавление тега List при генерации Items также зависит теперь от места вставки.
