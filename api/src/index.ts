...
import { KeyValuePair, KeyedCollection, safeString, IPair, OrderedCollection, getFromClioboard, positiveMin, copyToClipboard, createDir, pathExists, uriFromName } from './customs'
