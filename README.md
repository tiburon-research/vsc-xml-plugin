...
- `"tib.ignoreComments"` - игнорировать закомментированные элементы при автоподстановке;
...
Для всех основных тегов (кроме Ui) предлагается список возможных атрибутов. Если атрибут имеет предопределённый список значений, то этот список также подставляется. Для нестроковых атрибутов подставляется значение по умолчанию.
